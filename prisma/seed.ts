...
async function main() {
  ...
  const listingData = [
    { companyIdx: 0, title: "5 Tons Clean Steel Scrap", category: "METAL_SCRAP" as const, wasteType: "Steel", quantity: 5000, unit: "kg", price: 2250, location: "Houston, TX", tags: ["ferrous", "clean", "sorted"], industries: ["Automotive Manufacturing", "Construction"], co2: 9000, hazard: "NONE" as const },
    { companyIdx: 0, title: "Aluminum Offcuts Batch", category: "METAL_SCRAP" as const, wasteType: "Aluminum", quantity: 1200, unit: "kg", price: 1800, location: "Houston, TX", tags: ["non-ferrous", "aluminum", "high-value"], industries: ["Aerospace", "Packaging"], co2: 2160, hazard: "NONE" as const },
    { companyIdx: 0, title: "Copper Wire Scrap", category: "METAL_SCRAP" as const, wasteType: "Copper", quantity: 800, unit: "kg", price: 4800, location: "Houston, TX", tags: ["copper", "wire", "premium"], industries: ["Electronics", "Electrical Components"], co2: 1440, hazard: "NONE" as const },
    { companyIdx: 1, title: "HDPE Post-Industrial Regrind", category: "PLASTIC" as const, wasteType: "HDPE Plastic", quantity: 3000, unit: "kg", price: 750, location: "Detroit, MI", tags: ["HDPE", "post-industrial", "clean"], industries: ["Packaging", "Injection Molding"], co2: 7500, hazard: "NONE" as const },
    { companyIdx: 1, title: "PET Bottle Flakes", category: "PLASTIC" as const, wasteType: "PET", quantity: 5000, unit: "kg", price: 1250, location: "Detroit, MI", tags: ["PET", "flakes", "food-grade"], industries: ["Textile Manufacturing", "Bottle Production"], co2: 12500, hazard: "NONE" as const },
    { companyIdx: 1, title: "Mixed PP/PE Production Offcuts", category: "PLASTIC" as const, wasteType: "PP/PE Mix", quantity: 2000, unit: "kg", price: 400, location: "Detroit, MI", tags: ["mixed", "PP", "PE", "offcuts"], industries: ["Lumber Alternative", "Pallets"], co2: 5000, hazard: "NONE" as const },
    { companyIdx: 2, title: "Cotton Fabric Scraps — Sorted by Color", category: "TEXTILE_WASTE" as const, wasteType: "Cotton", quantity: 1500, unit: "kg", price: 450, location: "Los Angeles, CA", tags: ["cotton", "pre-consumer", "sorted"], industries: ["Insulation", "Paper Production"], co2: 4800, hazard: "NONE" as const },
    { companyIdx: 2, title: "Denim Cutting Waste", category: "TEXTILE_WASTE" as const, wasteType: "Denim", quantity: 2500, unit: "kg", price: 625, location: "Los Angeles, CA", tags: ["denim", "cutting-waste", "indigo"], industries: ["Insulation Manufacturing", "Automotive Interior"], co2: 8000, hazard: "NONE" as const },
    { companyIdx: 3, title: "Spent Catalyst Residue", category: "CHEMICAL_BYPRODUCTS" as const, wasteType: "Catalyst", quantity: 500, unit: "kg", price: 1500, location: "Philadelphia, PA", tags: ["catalyst", "precious-metals", "controlled"], industries: ["Precious Metal Recovery", "Chemical Processing"], co2: 250, hazard: "CLASS_6" as const },
    { companyIdx: 3, title: "Organic Solvent Waste — Acetone/Ethanol Mix", category: "CHEMICAL_BYPRODUCTS" as const, wasteType: "Solvents", quantity: 2000, unit: "liter", price: 600, location: "Philadelphia, PA", tags: ["solvent", "recyclable", "flammable"], industries: ["Solvent Recovery", "Fuel Production"], co2: 1000, hazard: "CLASS_3" as const },
    { companyIdx: 5, title: "Concrete Rubble from Demolition", category: "CONSTRUCTION_DEBRIS" as const, wasteType: "Concrete", quantity: 20000, unit: "kg", price: 1000, location: "Chicago, IL", tags: ["concrete", "rubble", "aggregate"], industries: ["Road Construction", "Fill Material"], co2: 4000, hazard: "NONE" as const },
    { companyIdx: 5, title: "Reclaimed Timber Beams", category: "WOOD" as const, wasteType: "Timber", quantity: 3000, unit: "kg", price: 900, location: "Chicago, IL", tags: ["timber", "reclaimed", "structural"], industries: ["Furniture", "Landscaping"], co2: 3000, hazard: "NONE" as const },
  ];
